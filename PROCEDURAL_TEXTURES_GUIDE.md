...
- **Ball textures** (solid colors, stripes, numbers, metallic/pearl effects)
...
User opens Texture Editor
  ↓
Select element (felt, ball, rail, etc.)
  ↓
...
#### **2.5 Geometric Pattern** (Stripes for balls)
...
3. **Custom ball decals** (upload logos, numbers)
