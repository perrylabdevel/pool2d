...
export const CONFIG = {
  ...
  BALL_ROTATION_MULTIPLIER: 0.15, // 2D overlay rotation multiplier (legacy)
  BALL_ROTATION_MULTIPLIER_3D: 1.0, // 3D rotation multiplier (1.0 = physically accurate rolling)
