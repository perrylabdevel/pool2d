...
export interface GeometrySettings {
  ...
  CORNER_POCKET_RADIUS_IN: number;
  SIDE_POCKET_RADIUS_IN: number;
...
export class SettingsManager {
  ...
  loadGeometrySettings(): GeometrySettings {
    const defaults: GeometrySettings = {
      ...
      CORNER_POCKET_RADIUS_IN: CONFIG.POCKET_RADIUS_CORNER,
      SIDE_POCKET_RADIUS_IN: CONFIG.POCKET_RADIUS_SIDE,
  ...
  resetGeometrySettings() {
    this.geometrySettings = {
      ...
      CORNER_POCKET_RADIUS_IN: 2.5,
      SIDE_POCKET_RADIUS_IN: 2.5,
  ...
  private applyGeometrySettings() {
    ...
    CONFIG.POCKET_RADIUS_CORNER = this.geometrySettings.CORNER_POCKET_RADIUS_IN;
    CONFIG.POCKET_RADIUS_SIDE = this.geometrySettings.SIDE_POCKET_RADIUS_IN;
