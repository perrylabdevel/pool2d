...
export interface GeometrySettings {
  ...
  CORNER_POCKET_OFFSET_X_IN: number;
  CORNER_POCKET_OFFSET_Y_IN: number;
  SIDE_POCKET_OFFSET_X_IN: number;
  SIDE_POCKET_OFFSET_Y_IN: number;
...
export const DEFAULT_GAME_SETTINGS: GameSettings = {
  ...
  POCKET_ANIMATION_DROP_DURATION_MS: CONFIG.POCKET_ANIMATION_DROP_DURATION_MS ?? 180,
  POCKET_ANIMATION_ROLL_DURATION_MS: CONFIG.POCKET_ANIMATION_ROLL_DURATION_MS ?? 250,
  POCKET_ANIMATION_SHRINK_FACTOR: CONFIG.POCKET_ANIMATION_SHRINK_FACTOR ?? 0.0,
  POCKET_ANIMATION_CLIP_START: CONFIG.POCKET_ANIMATION_CLIP_START ?? 0.2,
  POCKET_ANIMATION_CLIP_RADIUS_SCALE: CONFIG.POCKET_ANIMATION_CLIP_RADIUS_SCALE ?? 1.0,
  POCKET_ANIMATION_FADE_START: CONFIG.POCKET_ANIMATION_FADE_START ?? 0.9,
  POCKET_ANIMATION_FADE_DURATION: CONFIG.POCKET_ANIMATION_FADE_DURATION ?? 0.12,
};
...
export const DEFAULT_PHYSICS_SETTINGS: PhysicsSettings = {
  ...
  POCKET_ANIMATION_SHRINK_FACTOR: (CONFIG as any).POCKET_ANIMATION_SHRINK_FACTOR ?? 0.0,
  POCKET_ANIMATION_UNDERFELT_PX: (CONFIG as any).POCKET_ANIMATION_UNDERFELT_PX ?? 10,
  POCKET_ANIMATION_FADE_START: CONFIG.POCKET_ANIMATION_FADE_START ?? 0.9,
  POCKET_ANIMATION_FADE_DURATION: (CONFIG as any).POCKET_ANIMATION_FADE_DURATION ?? 0.12,
  POCKET_ANIMATION_CLIP_START: (CONFIG as any).POCKET_ANIMATION_CLIP_START ?? 0.2,
  POCKET_ANIMATION_CLIP_RADIUS_SCALE: CONFIG.POCKET_ANIMATION_CLIP_RADIUS_SCALE ?? 1.05,
...
export class SettingsManager {
  ...
  loadGameSettings(): GameSettings {
    try {
      ...
      if (stored) {
        let settings = { ...DEFAULT_GAME_SETTINGS, ...JSON.parse(stored) };

        // One-time reset of pocket animation settings (v2 - simplified animation)
        const pocketAnimResetKey = 'RailRush_pocket_anim_reset_v2';
        if (!localStorage.getItem(pocketAnimResetKey)) {
          console.log('[Settings] Resetting pocket animation settings to new defaults');
          settings = {
            ...settings,
            POCKET_ANIMATION_DROP_DURATION_MS: DEFAULT_GAME_SETTINGS.POCKET_ANIMATION_DROP_DURATION_MS,
            POCKET_ANIMATION_ROLL_DURATION_MS: DEFAULT_GAME_SETTINGS.POCKET_ANIMATION_ROLL_DURATION_MS,
            POCKET_ANIMATION_SHRINK_FACTOR: DEFAULT_GAME_SETTINGS.POCKET_ANIMATION_SHRINK_FACTOR,
            POCKET_ANIMATION_CLIP_START: DEFAULT_GAME_SETTINGS.POCKET_ANIMATION_CLIP_START,
            POCKET_ANIMATION_CLIP_RADIUS_SCALE: DEFAULT_GAME_SETTINGS.POCKET_ANIMATION_CLIP_RADIUS_SCALE,
            POCKET_ANIMATION_FADE_START: DEFAULT_GAME_SETTINGS.POCKET_ANIMATION_FADE_START,
            POCKET_ANIMATION_FADE_DURATION: DEFAULT_GAME_SETTINGS.POCKET_ANIMATION_FADE_DURATION,
          };
  ...
  loadGeometrySettings(): GeometrySettings {
    const defaults: GeometrySettings = {
      ...
      CORNER_POCKET_OFFSET_X_IN: (CONFIG as any).CORNER_POCKET_OFFSET_X_IN ?? 0,
      CORNER_POCKET_OFFSET_Y_IN: (CONFIG as any).CORNER_POCKET_OFFSET_Y_IN ?? 0,
      SIDE_POCKET_OFFSET_X_IN: (CONFIG as any).SIDE_POCKET_OFFSET_X_IN ?? 0,
      SIDE_POCKET_OFFSET_Y_IN: (CONFIG as any).SIDE_POCKET_OFFSET_Y_IN ?? 0,
  ...
  resetGeometrySettings() {
    this.geometrySettings = {
      ...
      CORNER_POCKET_OFFSET_X_IN: 0,
      CORNER_POCKET_OFFSET_Y_IN: 0,
      SIDE_POCKET_OFFSET_X_IN: 0,
      SIDE_POCKET_OFFSET_Y_IN: 0,
  ...
  private applyGeometrySettings() {
    ...
    (CONFIG as any).CORNER_POCKET_OFFSET_X_IN = this.geometrySettings.CORNER_POCKET_OFFSET_X_IN ?? 0;
    (CONFIG as any).CORNER_POCKET_OFFSET_Y_IN = this.geometrySettings.CORNER_POCKET_OFFSET_Y_IN ?? 0;
    (CONFIG as any).SIDE_POCKET_OFFSET_X_IN = this.geometrySettings.SIDE_POCKET_OFFSET_X_IN ?? 0;
    (CONFIG as any).SIDE_POCKET_OFFSET_Y_IN = this.geometrySettings.SIDE_POCKET_OFFSET_Y_IN ?? 0;
