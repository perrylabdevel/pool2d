...
export const GEOMETRY_RANGES = {
  side: {
    ...
    shelfDepth: { min: 0.0, max: 1.0, typical: 0.25 },
    railCurve: { min: 0.0, max: 1.0, typical: 0.0 },
  },
  corner: {
    mouthWidth: { min: 4.0, max: 10.0, typical: 5.0 },
    throatWidth: { min: 3.0, max: 9.0, typical: 4.125 },
    railDepth: { min: 1.0, max: 3.0, typical: 1.75 },
    jawDepth: { min: 0.5, max: 4.0, typical: 1.0 },
    shelfDepth: { min: 1.0, max: 3.0, typical: 1.75 },
    railCurve: { min: 0.0, max: 1.0, typical: 0.0 },
  },
  global: {
